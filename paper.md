...
As of January 2024, to the authors’ best knowledge no other open-source comparison library for fire perimeters  exists. Of note are many spatial tools and packages exist for calculating metrics of spatial matching. Package examples include PySAL @noauthor_pysal_nodate, Shapely [Cite], Geopandas [Cite]. General tool examples include ArcGIS Pro [cite] and QGIS [cite].
